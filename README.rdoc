...
== Loading Your Seeds
  ...
  Dir.glob(Rails.root.join("db","seeds","*.rb").to_s).each {|file| require file }

== Known Issues

* If your model uses protected attributes, seed dumps will fail to load due to mass-assignment issues.
